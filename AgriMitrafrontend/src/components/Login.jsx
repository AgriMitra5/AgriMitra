        ...
        <div className="container" style={{minHeight: '79vh'}}>
            ...
            <div className="col-sm-4 mx-auto text-center" style={{boxShadow: '0 0 2px 1px white'}}>
                ...
                <div className="card-body">
                    <img src={'https://www.iconpacks.net/icons/2/free-user-icon-3297-thumb.png'} alt="Company Logo" style={{width: 200}} className="my-2 rounded-circle" />
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" required placeholder="Email-Id OR User-ID" name="userid" value={user.userid} onChange={handleInput}className="form-control" />
                        </div>
                    </div>
                    <div className="form-group">
                        <div className="input-group">
                    ...
                    <input type="submit" onClick={handleSubmit} defaultValue="Login" className="btn btn-success btn-block" />
                    </form>
                </div>
                </div>
            </div>
