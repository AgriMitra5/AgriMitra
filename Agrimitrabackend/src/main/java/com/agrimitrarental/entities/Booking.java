package com.agrimitrarental.entities;
...
public class Booking {
	...
	private Farmer customer;
	@ManyToOne
	@JoinColumn(name="product_id")     //@JoinColumn(name="bike_id")
	...
	public Farmer getCustomer() {
		return customer;
	}
	public void setCustomer(Farmer customer) {
		this.customer = customer;
	}
	public Product getBike() {
		return bike;
	}
	public void setBike(Product bike) {
		this.bike = bike;
	}
	@Override
